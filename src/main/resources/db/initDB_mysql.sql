...
-- Table `supSite`.`roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `supSite`.`roles` (
  `id` INT NOT NULL,
...
-- Table `supSite`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `supSite`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
